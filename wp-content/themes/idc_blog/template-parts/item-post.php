...
<article class="blog_item">
    ...
    <div class="blog_details">
        ...
        <p style="text-align: left">
            <i class="ti-calendar"></i> <?php printf( /* translators: 1: date and time(s). */
                esc_html__('%1$s lúc %2$s', '5balloons_theme'), get_the_date(), get_the_time()) ?>
            &nbsp;|&nbsp;
            <a href="<?php echo esc_url(get_permalink()); ?>#commentsArea" title="<?php echo the_title(); ?> - Bình luận">
                <i class="ti-comments"></i> <?php echo get_comments_number(get_the_ID()); ?> Bình luận
            </a>
        </p>
    </div>
</article>
